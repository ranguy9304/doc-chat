...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper className="md-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className=" mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Chat-doc allows you to have chats with your doc. Simply upload your
